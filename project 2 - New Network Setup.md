...
1. Interfaces > Assignments > WAN > Enable > Enable DHCP **# Configure DHCP on WAN and enable the interface**
2. Interfaces > Assignments > LAN > 192.168.50.0/24 with range 192.168.50.10-192.168.50.254 **# Configure LAN on 192.168.50.0/24**
4. Terminal > “sudo dhclient -r” to release the current IP > “sudo dhclient” to pull the static IP **# Set pfSense as 192.168.50.1 static**
5. Terminal > “sudo dhclient -r” to release the current IP > “sudo dhclient” to pull the static IP **# Set NSM as 192.168.50.2 static**
6. Interfaces > Assignments > OPT > 192.168.100.0/24 with range 192.168.100.10-192.168.100.254 **# Configure OPT on 192.168.100.0/24**
8. Terminal > “sudo dhclient -r” to release the current IP > “sudo dhclient” to pull the static IP **# Set router to 192.168.100.1 static**


_Configure R1:_
1. Connect FW to WAN
2. R1: Network > WAN > Static > 192.168.100.1 **# Set a static WAN IP of 192.168.100.1**
3. R1: Network > LAN > Static > 192.168.150.1 **# Set a static LAN IP of 192.168.150.1 (just as a test – WAN and LAN IPs cannot be in the same subnet)**
...
_Firewall:_
1. Interfaces > Assignments > LAN > Static IP > 192.168.50.1 **# Create FW static 192.168.50.1**
2. Connect NSM to FW over LAN
3. Status > DHCP Leases > White ‘+’ next the the IP > Fill in static info **# Create NSM static 192.168.50.2**
4. Interfaces > Assignments > OPT > Static IP > 192.168.100.1 **# Create SW static 192.168.100.1**
5. Interfaces > Assignments > VLANS > 100 **# Create a SW VLAN**
6. Interfaces > Assignments > Add VLAN 100 to OPT **# Create a SW VLAN**
7. Firewall > Rules > OPT > Pass Any **# Create a SW VLAN**

_Switch:_ 
1. Connect SW to FW over OPT
...
- Configured the 100 VLAN on FW and SW and tied the interface to OPT and tagged port 8, did not create the 100 network. 
